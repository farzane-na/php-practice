...
<body>
        ...
        <nav class="nav">
            <div class="nav__property">
                ...
                <ul class="nav-menu">
                    ...
                    <li class="nav-manu__item">
                        <a href="./cart.php?token=<?php echo $_GET['token']; ?>" class="nav-menu__link nav-menu__link--active">
                            <svg>
                                <use href="#cart"></use>
                            </svg>
                            <span>cart</span>
                ...
                <div class="cart__wrapper">
                    ...
                    <div class="cart__box">
                        <article class="cart__item">
                            <div class="cart__img">
                                <img src="./asset/images/bag/1.jpg" alt="">
                            </div>
                            <div class="cart__info">
                                <div class="cart__property">
                                    <span class="cart__name">sfdvg</span>
                                    <span class="cart__price">dfdfb</span>
                                </div>
                                <div class="cart__handeler">
    ...
    <script src="./asset/scripts/cart.js" type="module"></script>
</body>
</html>