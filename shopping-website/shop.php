...
<body>
    ...
    <main class="main">
        <section class="section note-book">
            <div class="container">
                <h2 class="section__title">note book</h2>
                <div class="note-book__wrapper">

                </div>
            </div>
        </section>
        <section class="section stationery">
            <div class="container">
                <h2 class="section__title">stationery</h2>
                <div class="stationery__wrapper">
                    
                </div>
            </div>
        </section>
        <section class="section autograph">
            <div class="container">
                <h2 class="section__title">autograph</h2>
                <div class="autograph__wrapper">
